...
public class PlayerForTesting extends GameObjectForTesting {
    ...
    public PlayerForTesting(GameScreen gameScreen, String hero){
        super(gameScreen.getDefaultLayerViewport().halfWidth, gameScreen.getDefaultLayerViewport().getBottom()+(PORTRAIT_HEIGHT/2)+(70.0f/1.5f),
                PORTRAIT_WIDTH, PORTRAIT_HEIGHT, b, gameScreen);
    ...
    public void dealWeaponDamage(PlayerForTesting p){
