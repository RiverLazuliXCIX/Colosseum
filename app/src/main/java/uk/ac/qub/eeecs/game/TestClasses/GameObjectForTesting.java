 ...
 * @version 1.0
 */
public class GameObjectForTesting {
     ...
     */
    public GameObjectForTesting(GameScreen gameScreen) {
     ...
     * @param gameScreen Gamescreen to which this object belongs
     */
    public GameObjectForTesting(float x, float y, Bitmap bitmap, GameScreen gameScreen) {
        mGameScreen = gameScreen;
        ...
        if(bitmap != null) {
            ...
            throw new RuntimeException(
                    "GameObjectForTesting.constructor: If creating with a NULL bitmap then specify width/height.");
    }
     ...
     * @param gameScreen Gamescreen to which this object belongs
     */
    public GameObjectForTesting(float x, float y, float width, float height,
